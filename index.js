...
bootstrap()
  // https://github.com/wix-platform/wix-node-platform/tree/master/bootstrap-plugins/greyhound/wix-bootstrap-greyhound
  .use(require('@wix/wix-bootstrap-greyhound'))
